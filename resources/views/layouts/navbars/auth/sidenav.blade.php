<aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 "
    ...
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0" href="{{ route('home') }}">
            ...
            <span class="ms-1 font-weight-bold">ARCY</span>
        </a>
    </div>
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item mt-3 d-flex align-items-center">
                <div class="ps-4">
                    <i class="fa fa-house-medical" style="color: #f4645f;"></i>
                </div>
                <h6 class="ms-2 text-uppercase text-xs font-weight-bolder opacity-6 mb-0">Klinik</h6>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item mt-3 d-flex align-items-center">
                ...
                <h6 class="ms-2 text-uppercase text-xs font-weight-bolder opacity-6 mb-0">Apps Setting</h6>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="">
                    ...
                    <span class="nav-link-text ms-1">Info Klinik</span>
                </a>
            </li>
            <li class="nav-item mt-3 d-flex align-items-center">
                <div class="ps-4">
                    <i class="fa fa-clipboard" style="color: #05cccc"></i>
                </div>
                <h6 class="ms-2 text-uppercase text-xs font-weight-bolder opacity-6 mb-0">Blog / Berita</h6>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
                <a class="nav-link {{ Route::currentRouteName() == 'kategori-blog' ? 'active' : '' }}" href="{{ route('kategori-blog') }}">
                    <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
